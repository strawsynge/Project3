...
# line1 = ["莘庄","外环路","莲花路","锦江乐园","上海南站","漕宝路","上海体育馆"]
# delay1 = [2,2,3,3,3,2]
for i in range(len(line1)):
  S.append(station(line1[i],1))
for i in range(len(delay1)):
  path_map[i][i+1] = (delay1[i],i+1)
  path_map[i+1][i] = (delay1[i],i)
n = len(line1)
...
for i in range(len(delay2)):
  path_map[n+i][n+i+1] = (delay2[i],n+i+1)
  path_map[n+i+1][n+i] = (delay2[i],n+i)
n = n+len(line2)
...
for i in range(len(delay3)):
  path_map[n+i][n+i+1] = (delay3[i],n+i+1)
  path_map[n+i+1][n+i] = (delay3[i],n+i)
n = n+len(line3)
...
for i in range(len(delay4)):
  path_map[n+i][n+i+1] = (delay4[i],n+i+1)
  path_map[n+i+1][n+i] = (delay4[i],n+i)
n = n+len(line4)
...
for i in range(len(delay5)):
  path_map[n+i][n+i+1] = (delay5[i],n+i+1)
  path_map[n+i+1][n+i] = (delay5[i],n+i)
n = n+len(line5)
...
for i in range(len(delay6)):
  path_map[n+i][n+i+1] = (delay6[i],n+i+1)
  path_map[n+i+1][n+i] = (delay6[i],n+i)
n = n+len(line6)
...
for i in range(len(delay7)):
  path_map[n+i][n+i+1] = (delay7[i],n+i+1)
  path_map[n+i+1][n+i] = (delay7[i],n+i)
n = n+len(line7)
...
for i in range(len(delay8)):
  path_map[n+i][n+i+1] = (delay8[i],n+i+1)
  path_map[n+i+1][n+i] = (delay8[i],n+i)
n = n+len(line8)
...
for i in range(len(delay9)):
  path_map[n+i][n+i+1] = (delay9[i],n+i+1)
  path_map[n+i+1][n+i] = (delay9[i],n+i)
n = n+len(line9)
...
for i in range(26):
  path_map[n+i][n+i+1] = (delay10[i],n+i+1)
  path_map[n+i+1][n+i] = (delay10[i],n+i)
path_map[n+23][n+28] = (3,n+28)
path_map[n+28][n+23] = (3,n+23)
path_map[n+28][n+29] = (2,n+29)
path_map[n+29][n+28] = (2,n+28)
path_map[n+29][n+30] = (3,n+30)
path_map[n+30][n+29] = (3,n+29)
n = n+len(line10)
...
for i in range(len(delay11)):
  path_map[n+i][n+i+1] = (delay11[i],n+i+1)
  path_map[n+i+1][n+i] = (delay11[i],n+i)
# 嘉定新城-上海赛车场
path_map[n+26][n+30] = (4,n+30)
path_map[n+30][n+26] = (4,n+26)
# 上海赛车场-花桥
delay11_1 = [6,3,3,2,3,2]
for i in range(6):
  path_map[n+30+i][n+30+i+1] = (delay11_1[i],n+30+i+1)
  path_map[n+30+i+1][n+30+i] = (delay11_1[i],n+30+i)
n = n+len(line11)
...
for i in range(len(delay12)):
  path_map[n+i][n+i+1] = (delay12[i],n+i+1)
  path_map[n+i+1][n+i] = (delay12[i],n+i)
n = n+len(line12)
...
for i in range(len(delay13)):
  path_map[n+i][n+i+1] = (delay13[i],n+i+1)
  path_map[n+i+1][n+i] = (delay13[i],n+i)
n = n+len(line13)
...
for i in range(len(delay16)):
  path_map[n+i][n+i+1] = (delay16[i],n+i+1)
  path_map[n+i+1][n+i] = (delay16[i],n+i)
n = n+len(line16)
  ...
  for i in sec:
    for j in sec:
      if i!=j:
        path_map[i][j] = (0,j)
        path_map[j][i] = (0,i)
        path_map1[i][j] = (1000,j)
        path_map1[j][i] = (1000,i)
...
while 1:
  ...
  for i in range(S_num):
    if S[i].name == start:
      start = i
      break
  if type(start) is not types.IntType:
    print "NO such starting station."
    continue
  ...
  for i in range(S_num):
    if S[i].name == end:
      ...
      break
  if type(end) is not types.IntType:
    print "NO such destination station."
    continue
  ...
  path_1 = []
  newend_1 = end
  while newend_1 != start:
    path.append(S[newend_1])
    if newend_1 == path_map_1[start][newend_1][1]:
      break
    else:
      newend_1 = path_map_1[start][newend_1][1]
  path_1.append(S[start])
  print "Least delay with link-state routing:"
  for i in reversed(path_1):
    print "Line", i.line, i.name

  #Least switching times with link-state routing
  path_2 = []
  newend_2 = end
  while newend_2 != start:
    path.append(S[newend_2])
    if newend_2 == path_map_2[start][newend_2][1]:
      break
    else:
      newend_2 = path_map_2[start][newend_2][1]
  path_2.append(S[start])
  print "Least switching times with link-state routing:"
  for i in reversed(path_2):
    print "Line", i.line, i.name

  #Least delay with distance-vector routing
  path_3 = []
  newend_3 = end
  while newend_3 != start:
    path.append(S[newend_3])
    if newend_3 == path_map_3[start][newend_3][1]:
      break
    else:
      newend_3 = path_map_3[start][newend_3][1]
  path_3.append(S[start])
  print "Least delay with distance-vector routing:"
  for i in reversed(path_3):
    print "Line", i.line, i.name

  #Least switching times with distance-vector routing
  path_4 = []
  newend_4 = end
  while newend_4 != start:
    path.append(S[newend_4])
    if newend_4 == path_map_4[start][newend_4][1]:
      break
    else:
      newend_4 = path_map_4[start][newend_4][1]
  path_4.append(S[start])
  print "Least switching times with distance-vector routing:"
  for i in reversed(path_4):
    print "Line", i.line, i.name
